...
function Content({ totalUsersData, totalPostsData }) {
  return (
    <div className='px-10 rounded-lg'>
      ...
      <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatibus doloremque delectus illo! Exercitationem architecto saepe natus eligendi mollitia dolorem, error pariatur dolores voluptatum, vero quae fugit voluptatibus quas officiis dolor.</p>
    </div>
  )
}
